"""Tests for the BSNexus admin MCP OAuth protected-resource wrapper (RFC 9728)."""

from __future__ import annotations

import pytest

from backend.src.admin_mcp.oauth_protected_resource import (
...
async def test_wrapper_returns_401_with_www_authenticate_when_missing():
    ...
    scope = {
        ...
        "headers": [
            ...
            (b"x-forwarded-host", b"nexus.bsvibe.dev"),
        ],
        "scheme": "http",
        "server": ("internal", 80),
    }
    ...
    assert b"nexus.bsvibe.dev/.well-known/oauth-protected-resource" in www
