    ...
    return [
        {
            ...
            "content": (
                ...
                "8. USE THE WORKSPACE TOOLCHAIN AS-IS. The workspace environment already has the "
                "project's standard toolchain installed. Run the test and lint commands directly; "
                "do NOT spend rounds reinstalling dependencies — installs waste rounds and can "
                "fail in ways unrelated to your code.\n"
                "9. GREEN BEFORE YOU FINISH. Before sending your plain-text summary (which exits "
                "the loop), run the project's full verifier — every test command AND every "
